...
const homeTitle = "PulsaKilat | Pulsa, Paket Data, E-Wallet, Token Listrik, Game & PPOB";
const homeDescription =
  "PulsaKilat melayani isi pulsa, paket data, top up e-wallet, token listrik, top up game, dan pembayaran PPOB dengan alur cepat untuk pelanggan, member, dan agen.";
...
export default async function GuestHomePage() {
  ...
  const catalogJsonLd = {
    ...
    mainEntity: {
      "@type": "OfferCatalog",
      name: "Kategori Produk PulsaKilat",
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Produk apa saja yang tersedia di PulsaKilat?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "PulsaKilat menyediakan isi pulsa, paket data, top up e-wallet, token listrik, top up game, BPJS, PDAM, internet pascabayar, TV, dan layanan PPOB lain untuk pelanggan, member, dan agen.",
        },
      },
      {
        "@type": "Question",
        name: "Apakah PulsaKilat cocok untuk calon member dan agen?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ya. PulsaKilat bisa dipakai untuk kebutuhan transaksi harian sekaligus untuk member, agen, reseller, dan kebutuhan H2H dengan katalog produk digital yang lengkap.",
        },
      },
      {
        "@type": "Question",
        name: "Apa keunggulan PulsaKilat untuk transaksi produk digital?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "PulsaKilat menata kategori produk secara jelas, menyediakan banyak layanan dalam satu tempat, dan memudahkan pembeli maupun penjual untuk melayani kebutuhan digital harian dengan lebih cepat.",
        },
      },
    ],
  };
