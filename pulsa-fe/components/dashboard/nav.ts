...
export const adminNavSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { href: "/dashboard/admin/transaksi/aplikasi", label: "Transaksi Retail" },
      { href: "/dashboard/admin/transaksi/aplikasi/provider", label: "Fulfillment Retail" },
      { href: "/dashboard/admin/transaksi/guest-refund", label: "Refund Guest Pending" },
      { href: "/dashboard/admin/transaksi/member", label: "Transaksi H2H" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/admin/deposit-va", label: "Deposit VA" },
      { href: "/dashboard/admin/wallet/members", label: "Dompet Member" },
      { href: "/dashboard/admin/provider-wallets", label: "Dompet Provider" },
      { href: "/dashboard/admin/provider-accounts", label: "Rekening Provider" },
      { href: "/dashboard/admin/qrtp-transfer", label: "Transfer QRTP ke Provider" },
      { href: "/dashboard/admin/retail-withdraws", label: "Withdraw Retail" },
      { href: "/dashboard/admin/h2h-withdraws", label: "Withdraw H2H" },
      { href: "/dashboard/admin/wallet-history/members", label: "Riwayat Deposit Member" },
      { href: "/dashboard/admin/wallet-history/providers", label: "Riwayat Deposit Provider" },
      { href: "/dashboard/admin/internal-finance", label: "Pengeluaran Internal" },
      { href: "/dashboard/admin/bank", label: "Bank" },
      { href: "/dashboard/admin/debit-tanpa-pasangan", label: "Debit Tanpa Pasangan" },
    ],
  },
  {
    title: "Produk & Harga",
  ...
  },
  {
    ...
    items: [
      { href: "/dashboard/admin/provider/analytics", label: "Analitik Provider" },
      { href: "/dashboard/admin/provider/produk-sukses", label: "Produk Sukses Harian" },
      { href: "/dashboard/admin/transaksi/anomali-provider", label: "Anomali Provider" },
      { href: "/dashboard/admin/transaksi/transaksi-suspect", label: "Transaksi Provider Suspect" },
      { href: "/dashboard/admin/wallet-activity", label: "Aktivitas Wallet" },
      { href: "/dashboard/admin/transaksi/member-status-logs", label: "Log Status Member" },
      { href: "/dashboard/admin/transaksi/status-mismatch", label: "Status Mismatch" },
    ],
  },
];
